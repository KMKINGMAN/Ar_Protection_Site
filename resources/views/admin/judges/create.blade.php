<div class="modal-dialog">
    <div class="modal-content model-height">
        <div class="modal-header">
            <h5 class="modal-title text-dark" id="exampleModalLabel">اضافة قاضى جديدة </h5>

        </div>
        <form action="{{ route('judges.store') }}" method="POST" enctype="multipart/form-data" id="add_judge_form">
            @csrf
...
<script>
    ...
    $('#add_judge_form').submit(function(e) {
        e.preventDefault();
                ...
                if (response.status === true) {
                    ...
                    let new_issue = `<tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" data-toggle="modal" data-target="#modal" data-id="${ response.data.id }" class="btn btn-info btn-sm edit_judge">تعديل</a>
